...
test.each([
  ...
  // The stylesheet the real sweep reports for this bundle; see DOCKKIT_CSS in
  // transform-corpus-check.ts for why it is the primitives' source file rather
  // than dockkit's own module.
