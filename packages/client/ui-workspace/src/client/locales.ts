...
export const zh = {
  ...
  'group.archived': '已归档',
  'archived.hint': '归档的会话不显示在分组中，日志与位置都保留。',
  'archived.restoreOpen': '恢复并打开',
  'settings.archived.nav': '已归档的会话',
  'settings.archived.empty': '还没有归档过的会话。会话行的「归档会话」会把它收到这里。',
  'session.start.failed': '新会话没能建起来：',
  'archived.delete': '删除会话',
  'archived.deleteWarning': '删除后无法恢复',
  'archived.deleteConfirm': '确认删除',
  'archived.deleteCancel': '取消',
  'archived.deleteFailed': '删除失败：',
  'archived.deleting': '正在删除；若会话仍在回复，将等本轮回复和工具执行结束。',
...
export const en = {
  ...
  'archived.hint': 'Archived sessions are hidden from groups; their log and place are kept.',
  'archived.restoreOpen': 'Restore and open',
  'settings.archived.nav': 'Archived sessions',
  'settings.archived.empty': 'No sessions are archived yet. A row’s “Archive session” puts it here.',
  'session.start.failed': 'Could not start a session: ',
  'archived.delete': 'Delete session',
  'archived.deleteWarning': 'Cannot be undone',
  'archived.deleteConfirm': 'Delete',
  'archived.deleteCancel': 'Cancel',
