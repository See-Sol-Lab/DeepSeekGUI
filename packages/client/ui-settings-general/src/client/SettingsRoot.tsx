...
function navIcon(id: string) {
  ...
  // DeepSeekGUI desktop sections (settings-plugin): distinct glyphs so the
  // rail does not read as five identical gears (acceptance 2026-09-06).
  if (id === 'deepseekgui-harness') return <IconCodeOutline16 className={css.navIcon} size={16} />
