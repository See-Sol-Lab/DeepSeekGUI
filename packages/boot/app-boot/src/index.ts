...
// stays exported beside the boot API it reuses. Only the one name apps/cli
// actually imports through the package — the other six had no importer
// anywhere, and every extra re-export here widens the fork's surface against
// upstream for nothing.
export { inspectExistingProfiles } from './inspect.ts'
