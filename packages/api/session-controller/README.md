...
Desktop-authorized deletion rejects new submissions, waits for Agent activity, disposes the owned handle, and delegates content cleanup to persistence. It refuses another component’s live Agent and independently owned child sessions. Incomplete deletion remains available for retry.
