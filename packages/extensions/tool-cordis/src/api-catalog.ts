...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'abstract revertFile(cwd: string, path: string): Promise<void>',
  ...
  },
  {
    ...
    summary: 'Read-only Remote namespace; no Session events, model requests, or writes.',
    description: 'Read-only Remote namespace; no Session events, model requests, or writes.',
    methods: [
      {
