...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Full-width entries in the Hero column, above the workspace row.',
    doc: 'Full-width entries in the Hero column, above the workspace row.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workspace ArchivedSessionsSection id \'deepseekgui-archived\'',
    ],
    replaceRisk: 'none',
