...
Session deletion serializes removal of live and persisted search documents with index work, then advances the search generation. A failed cleanup is not reported as a completed deletion.
