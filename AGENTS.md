...
Everything above is the upstream `AGENTS.md`, verbatim — never rewrite it here. DeepSeekGUI's GUI-layer rules: [DEEPSEEKGUI.md](DEEPSEEKGUI.md), [apps/desktop/README.md](apps/desktop/README.md).
