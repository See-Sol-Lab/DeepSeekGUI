...
function excluded(file: string): boolean {
  ...
  // Regenerated by the staging npm install (build-desktop-dist writes it back);
  // upstream bin names (e.g. cordis's own "bin": {"cordis": ...}) live here
  // verbatim from registry metadata and are not rescope residue.
  if (file === 'apps/deepseekgui/runtime.package-lock.json') return true
