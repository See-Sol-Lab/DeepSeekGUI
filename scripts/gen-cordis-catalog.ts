...
export const SERVICE_PAGE: Record<string, string> = {
  workbenchInspector: 'workbench-inspection.md',
  agentLoop: 'core.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  chatTextDisplay: 'client-side optional slot-contract accessor (ChatTextDisplay) for assistant-prose smoothing — packages/client/ui-chat/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionDeletionRecord: 'persistence.md',
  ...
  WorktreeInfo: 'git.md',
  CommitInfo: 'git.md',
  AuthorIdentity: 'git.md',
  GitCommitResult: 'git.md',
  RemoteInfo: 'git.md',
  PushPreview: 'git.md',
  PushApproval: 'git.md',
  PushOutcome: 'git.md',
  ...
  DiffResult: 'git.md',
  DiffScope: 'git.md',
  PullRequestAuth: 'pull-request.md',
  PullRequestAvailability: 'pull-request.md',
  ExistingPullRequest: 'pull-request.md',
  CreatedPullRequest: 'pull-request.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  WorkbenchFileText: 'Bounded text response owned by packages/api/workbench-inspector/README.md',
  WorkbenchRepository: 'Repository read response owned by packages/api/workbench-inspector/README.md',
  WorkbenchOverview: 'Repository overview response owned by packages/api/workbench-inspector/README.md',
  WorkbenchMemory: 'Project memory response owned by packages/api/workbench-inspector/README.md',
  WorkbenchLastReply: 'Newest assistant reply response owned by packages/api/workbench-inspector/README.md',
