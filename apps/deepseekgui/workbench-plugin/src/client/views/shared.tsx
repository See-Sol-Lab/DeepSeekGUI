...
/**
 * Toolbar: refresh plus whatever the view adds. The generic "open the
 * workspace in the file manager" button that used to sit here (D7) is gone:
 * the official right Sidebar now carries a real file tree, so the button was
 * a second, worse way to the same place (2026-09-11 manual test #4). Memory
 * keeps its own, more specific file-manager buttons as children.
 */
export function Toolbar({ t, refresh, children }: {
  t: Translate
  refresh: () => void
