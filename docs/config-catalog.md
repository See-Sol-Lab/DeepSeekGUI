...
Source: [`packages/llm/llm-deepseek/src/index.ts:139`](../packages/llm/llm-deepseek/src/index.ts)
...
Requires: `fs` · `git` · `typert` · `sessionQuery` · `sessionController`
...
Source: [`packages/api/workbench-inspector/src/index.ts:20`](../packages/api/workbench-inspector/src/index.ts)
...
- `@deepseek-ai/dsh-git-local` — requires `subprocess` ([`packages/git/git-local/src/index.ts`](../packages/git/git-local/src/index.ts))
...
- `@deepseek-ai/dsh-pull-request-gh` — requires `subprocess` ([`packages/pull-request/pull-request-gh/src/index.ts`](../packages/pull-request/pull-request-gh/src/index.ts))
...
- `@deepseek-ai/dsh-git` — abstract `GitCapability` ([`packages/git/git/src/index.ts`](../packages/git/git/src/index.ts))
...
- `@deepseek-ai/dsh-pull-request` — abstract `PullRequestCapability` ([`packages/pull-request/pull-request/src/index.ts`](../packages/pull-request/pull-request/src/index.ts))
