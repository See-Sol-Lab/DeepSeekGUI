...
<a id="deepseek-aidsh-workbench-inspector"></a>

## `@deepseek-ai/dsh-workbench-inspector`

需要：`fs` · `git` · `typert` · `sessionQuery`
...
来源：[`packages/api/workbench-inspector/src/index.ts:17`](../packages/api/workbench-inspector/src/index.ts)
...
- `@deepseek-ai/dsh-git-local` — 需要 `subprocess`（[`packages/git/git-local/src/index.ts`](../packages/git/git-local/src/index.ts)）
...
- `@deepseek-ai/dsh-pull-request-gh` — 需要 `subprocess`（[`packages/pull-request/pull-request-gh/src/index.ts`](../packages/pull-request/pull-request-gh/src/index.ts)）
...
- `@deepseek-ai/dsh-git` — 抽象 `GitCapability`（[`packages/git/git/src/index.ts`](../packages/git/git/src/index.ts)）
...
- `@deepseek-ai/dsh-pull-request` — 抽象 `PullRequestCapability`（[`packages/pull-request/pull-request/src/index.ts`](../packages/pull-request/pull-request/src/index.ts)）
